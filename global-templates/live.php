...
<div id="home-live">
    <div class="hidden-sx section parallax" style="background: url('http://guillermo-jimenez.local/wp-content/uploads/2019/02/pc-mockup-for-website-sm.jpg');
    ...
    >
        <div class="container text-light">
            <div class="col-md-6 px-0 text-light live-h">
                ...
                <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">Join us Sundays at: <br> 9:30AM, 11:45AM, 2:00PM, 6:30PM PST</a></p>
