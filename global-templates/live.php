...
<div id="home-live">
  <div class="hidden-sx section parallax"
    style="background: url('http://guillermo-jimenez.local/wp-content/uploads/2019/02/pc-mockup-for-website-sm.jpg');
    ...
    <div class="container text-light">
      <div class="col-md-6 px-0 text-light live-h">
        ...
        <a href="<?php echo get_theme_mod('home_podcast_button_url', '#'); ?>">
          <button type="button"
            class="btn btn-primary"><?php echo get_theme_mod('home_podcast_button_text', 'Watch now'); ?></button>
        </a>
      </div>
    </div>
  </div>
