...
<div id="home-podcast">
    <div class="hidden-sx section split-color-back py-5">
        <h3 class="text-center section-header"><?php echo get_theme_mod('home_podcast_heading', 'Your best is yet to come!'); ?></h3>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <p>When Brian Houston – Global Founder and Senior Pastor of Hillsong Church – set out to pioneer with 40 people and a school hall, he was unsure of the highs and lows, sacrifices and disappointments that would mark the 32-year journey of miraculous opportunities and dreams come true.</p>
                    <p>Live, Love, Lead is his story, woven in to the greatest story ever told, with room for chapters all your own to be written and re-written. This book is a declaration to your future, a reminder that belief, passion and calling can give way to a full and abundant life, despite any mysteries, setbacks or mountains that get in the way.</p>
                    <div class="text-center top-pad">
                        <!-- <a href="<?php echo get_theme_mod('home_podcast_button_url', '#'); ?>">
                            <button type="button" class="btn btn-outline-primary"><?php echo get_theme_mod('home_podcast_button_text', 'YAY I build a theme'); ?></button>
                        </a> -->
                        <div>
